...
async def main():
    ...
    print(f"--- BACKEND HEATMAP PRE-VERIFICATION METRICS ---")
    ...
    crime_risks = [p.risk_crime for p in points if p.risk_crime is not None]
    lighting_risks = [p.risk_lighting for p in points if p.risk_lighting is not None]
